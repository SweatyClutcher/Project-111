...
df = pd.read_csv("interventions_data\studentMarks.csv")
...
df = pd.read_csv("interventions_data\data1.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("interventions_data\data2.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("interventions_data\data3.csv")
data = df["Math_score"].tolist()
